...
<html lang="en">
    ...
    <body>
        <section id="NAVIGATION">
            <nav class="p-3 bg-black md:flex md:items-center md:justify-between z-0">
                ...
                <ul class="text-white md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-black w-full left-0 md:py-0 md:pl-0 pl-7 md:opacity md:flex justify-end flex-wrap">
                    ...
                    <li class="m-3 md:my-0">
                        <a class="border-solid border-2 border-slate-400 py-2 px-12 rounded-xl hover:bg-gray-800 duration-200 hover:text-red-500">
                            Login
                        </a>
                    </li>
                    <li class="m-3 md:my-0">
                        <a href="createaccount.html" class="py-2 px-4 bg-slate-400 rounded-xl hover:bg-gray-800 duration-200 hover:text-red-500">
                            Create Account
                        </a>
                    </li>
                </ul>
        ...
        <section class="h-screen w-full bg-cover bg-center overflow-x-hidden relative flex-wrap"
        style="background-image: url(./img/Spacebackground\ copy.jpg)">
        <div class="w-[34rem] h-full bg-gray-800 flex-col p-10 flex justify-center opacity-95">
            <div>
                <p class="text-white text-5xl font-medium -mt-14">Login</p>
            </div>
            <div class="mt-6">
                <div class="pt-10 pr-20">
                    <p class="text-lg font-normal text-white mb-1">Username</p>
                    <input
                        type="text"
                        name="username"
            ...
            <div class="-mt-3">
                <div class="pt-10 pr-20">
                    <p class="text-lg font-normal text-white mb-1">Password</p>
                    <input
                        type="password"
                        name="password"
                        placeholder="Enter password"
                        class="w-full bg-slate-800 py-4 px-5 border hover: border-white rounded-lg shadow text-base font-sans text-white"/>
                <p class="text-sm font-normal text-white opacity-50 underline mt-1">Forgot password?</p>
                </div>
            </div>
            <div class="mt-16">
                <div class="h-[3.8rem] w-[24rem] rounded-xl px-6 bg-slate-600 flex justify-center items-center mt-1 hover:bg-black duration-300">
                    <p class="text-xl text-white font-medium">Login</p>
                </div>
                <p href="createaccount.html" class="text-sm font-normal text-white opacity-50 underline mt-1">Create account now!</p>
            </div>
        </div>
        </section>
